...
export default function ProfileHeaderC() {
    ...
    <div className="bg-white rounded-lg shadow-md p-6">
      <div className="flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-6">
        ...
        <div className="flex-grow">
            ...
            {isEditingName ? (
              <>
                <input
                  ...
                  className="text-2xl font-bold text-gray-800 border-b-2 border-[#229799] focus:outline-none w-full max-w-[200px]"
                />
          ...
          <div className="mt-4">
            <Card title="Total Spent on Tips" value={`$${customerData.totalSpent.toFixed(2)}`} />
          </div>
        </div>
      </div>
      {showConfirmation && (
