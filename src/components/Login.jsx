...
export default function Login({ onLoginSuccess }) {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      switch (userType) {
        case 'owner':
          endpoint = 'http://localhost:3000/api/auth/login-store';
          break;
        case 'staff':
          endpoint = 'http://localhost:3000/api/auth/login-staff';
          break;
        default:
          endpoint = 'http://localhost:3000/api/auth/login-customer';
      }
