    ...
    <header className="absolute top-0 left-0 w-full bg-transparent py-4 px-6 z-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center">
          <img src={logo} alt="Logo" className="sm:h-14 sm:mr-4 h-10 mr-3" />
          <span className="text-2xl font-bold text-white">TIPNEX</span> {/* Ensure the text is white for visibility */}
        </div>
